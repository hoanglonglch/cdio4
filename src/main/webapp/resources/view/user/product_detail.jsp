...
<section class="main-content">
	<div class="row">
		<div class="span9">
			<div class="row">
				<div class="span4">
					<a href="resources/themes/images/ladies/1.jpg" class="thumbnail"
						data-fancybox-group="group1" title="Description 1"><img alt=""
						src="resources/themes/images/ladies/1.jpg"></a>
					<ul class="thumbnails small">
						<li class="span1"><a href="resources/themes/images/ladies/2.jpg"
							class="thumbnail" data-fancybox-group="group1"
							title="Description 2"><img src="resources/themes/images/ladies/2.jpg"
								alt=""></a></li>
						<li class="span1"><a href="resources/themes/images/ladies/3.jpg"
							class="thumbnail" data-fancybox-group="group1"
							title="Description 3"><img src="resources/themes/images/ladies/3.jpg"
								alt=""></a></li>
						<li class="span1"><a href="resources/themes/images/ladies/4.jpg"
							class="thumbnail" data-fancybox-group="group1"
							title="Description 4"><img src="resources/themes/images/ladies/4.jpg"
								alt=""></a></li>
						<li class="span1"><a href="resources/themes/images/ladies/5.jpg"
							class="thumbnail" data-fancybox-group="group1"
							title="Description 5"><img src="resources/themes/images/ladies/5.jpg"
								alt=""></a></li>
					</ul>
				</div>
				<div class="span5">
							...
							<div class="active item">
								<ul class="thumbnails listing-products">
									<li class="span3">
										<div class="product-box">
											<span class="sale_tag"></span> <a href="product_detail"><img
												alt="" src="resources/themes/images/ladies/6.jpg"></a><br /> <a
												href="product_detail" class="title">Wuam ultrices
									...
									<li class="span3">
										<div class="product-box">
											<span class="sale_tag"></span> <a href="product_detail"><img
												alt="" src="resources/themes/images/ladies/5.jpg"></a><br /> <a
												href="product_detail" class="title">Fusce id
									...
									<li class="span3">
										<div class="product-box">
											<a href="product_detail"><img alt=""
												src="resources/themes/images/ladies/4.jpg"></a><br /> <a
												href="product_detail" class="title">Praesent tempor
							...
							<div class="item">
								<ul class="thumbnails listing-products">
									<li class="span3">
										<div class="product-box">
											<span class="sale_tag"></span> <a href="product_detail"><img
												alt="" src="resources/themes/images/ladies/1.jpg"></a><br /> <a
												href="product_detail" class="title">Fusce id
												molestie massa</a><br /> <a href="#" class="category">Phasellus
												consequat</a>
											<p class="price">$341</p>
									...
									<li class="span3">
										<div class="product-box">
											<a href="product_detail"><img alt=""
												src="resources/themes/images/ladies/2.jpg"></a><br /> <a
												href="product_detail">Praesent tempor sem</a><br /> <a
									...
									<li class="span3">
										<div class="product-box">
											<span class="sale_tag"></span> <a href="product_detail"><img
												alt="" src="resources/themes/images/ladies/3.jpg"></a><br /> <a
												href="product_detail" class="title">Wuam ultrices
												rutrum</a><br /> <a href="#" class="category">Suspendisse
												aliquet</a>
											<p class="price">$341</p>
		...
		<div class="span3 col">
			<div class="block">
				<ul class="nav nav-list">
					...
					<li class="active"><a href="products">Phasellus
							ultricies</a></li>
						...
						<div class="active item">
							<ul class="thumbnails listing-products">
								<li class="span3">
									<div class="product-box">
										<span class="sale_tag"></span> <a href="product_detail"><img
											alt="" src="resources/themes/images/ladies/7.jpg"></a><br /> <a
											href="product_detail" class="title">Fusce id
						...
						<div class="item">
							<ul class="thumbnails listing-products">
								<li class="span3">
									<div class="product-box">
										<a href="product_detail"><img alt=""
											src="resources/themes/images/ladies/8.jpg"></a><br /> <a
											href="product_detail" class="title">Tempor sem
