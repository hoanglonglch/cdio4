			...
			<table class="table table-striped">
				...
				<tbody>
					<tr>
						...
						<td><a href="product_detail"><img alt=""
								src="resources/themes/images/ladies/9.jpg"></a></td>
					...
					<tr>
						<td><input type="checkbox" value="option1"></td>
						<td><a href="product_detail"><img alt=""
								src="resources/themes/images/ladies/1.jpg"></a></td>
					...
					<tr>
						<td><input type="checkbox" value="option1"></td>
						<td><a href="product_detail"><img alt=""
								src="resources/themes/images/ladies/3.jpg"></a></td>
								...
								<li class="span3">
									<div class="product-box">
										<span class="sale_tag"></span> <a href="product_detail"><img
											alt="" src="resources/themes/images/ladies/2.jpg"></a><br /> <a
